...
%
% Usage: dx_gx = risk-genes(disorder)
%
% Lists GWAS_derived risk genes for specific diseases/disorders
%   Inputs (pick one)
...
% SL | added adhd on August 1st 2020 (1st day of NHL playoffs!!!!!)

switch disorder
    case 'adhd'                  
        dx_gx                     = {'ST3GAL3', 'KDM4A', 'KDM4A_AS1', 'PTPRF', 'SLC6A9', 'ARTN', 'DPH2', ...
    ...
    case 'tourette'
        dx_gx                     = {'FLT3', 'OTUD1', 'LINC01122', 'MIR2113', 'CSMD3', 'MIR2053', 'EPB41', 'MECR', 'OPRD1', ...
